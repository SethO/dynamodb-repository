...
describe('When creating item', () => {
  ...
  it('should call dynamodb get item', async () => {
    // ARRANGE
    const item = { id: 'foo' };
    const repo = new KeyValueRepository({ tableName: 'x', hashKeyName: 'id' });
  ...
  it('should use the original createdAt field', async () => {
    ...
    AWSMock.mock(DocumentClient, 'get', getStub);
    AWSMock.mock(DocumentClient, 'put', putStub);
    const repo = new KeyValueRepository({ tableName: 'x', hashKeyName: 'key' });
  ...
  it('should call dynamodb put with table name', async () => {
    ...
    const repo = new KeyValueRepository({ tableName, hashKeyName: 'id' });
  ...
  it('should call dynamodb put with item', async () => {
    ...
    const repo = new KeyValueRepository({ tableName: faker.lorem.word(), hashKeyName: 'key' });
  ...
  it('should overwrite updatedAt property', async () => {
    ...
    const repo = new KeyValueRepository({ tableName: 'items', hashKeyName: 'key' });
